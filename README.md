...
```bash
git clone --recursive git@github.com:Nilanzva/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
```
...
Copyright (c) 2019 Nilan Bhasima | Licensed under [MIT license](http://nilanzva.mit-license.org)
